...
- 対象の代表例（案）: ロキソニン（ロキソプロフェン）、アレグラ（フェキソフェナジン）、アレジオン（エピナスチン）、
  ...
  ヒルドイド（ヘパリン類似物質）、リンデロンV/VG、ロコイド、ムコダイン（カルボシステイン）、PL配合顆粒、
...
POLICY_THEMES = [
    ...
    {"tag": "上乗せ料金",
     "desc": "リンデロンV・リンデロンVG・ロコイドは上乗せ料金の対象？ステロイド外用薬の強さと市販薬",
     "facts": "3つとも対象（案）。市販リンデロンVsはVと同濃度だがVGの抗生物質は入っていない。顔・広範囲・長期使用は避ける。",
