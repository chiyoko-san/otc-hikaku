...
export const OTC_SIMILAR_GROUPS: { key: OtcSimilarGroup; label: string; lead: string }[] = [
  ...
  { key: 'steroid', label: 'ステロイド外用薬', lead: 'リンデロンV・ロコイド・リドメックスなど。リンデロンVG（ゲンタマイシン配合）は対象外。' },
...
export const OTC_SIMILAR_77: OtcSimilarIngredient[] = [
  ...
  { no: 27, name: 'サリチル酸メチル・dl-カンフル・トウガラシエキス', use: '鎮痛消炎剤', group: 'pain', ingredientKeys: ['サリチル酸メチル', 'カンフル', 'トウガラシ'], matchAll: true, rxExamples: ['MS温シップ', 'ラクール温シップ'] },
  { no: 28, name: 'サリチル酸メチル・l-メントール・dl-カンフル', use: '鎮痛消炎剤', group: 'pain', ingredientKeys: ['サリチル酸メチル', 'メントール', 'カンフル'], matchAll: true, excludeKeys: ['トウガラシ', 'グリチルレチン酸'], rxExamples: ['MS冷シップ'] },
  { no: 29, name: 'サリチル酸メチル・l-メントール・dl-カンフル・グリチルレチン酸', use: '鎮痛消炎剤', group: 'pain', ingredientKeys: ['サリチル酸メチル', 'メントール', 'カンフル', 'グリチルレチン酸'], matchAll: true, rxExamples: ['ラクール冷シップ'] },
  ...
  { no: 58, name: 'フルチカゾンプロピオン酸エステル', use: 'ステロイド', group: 'allergy', ingredientKeys: ['フルチカゾンプロピオン酸'], rxExamples: ['フルチカゾン点鼻液（フルナーゼの後発品）'] },
  ...
  { no: 61, name: 'ベタメタゾン吉草酸エステル・フラジオマイシン硫酸塩', use: 'ステロイド', group: 'steroid', ingredientKeys: ['ベタメタゾン吉草酸', 'フラジオマイシン'], matchAll: true, rxExamples: ['ベトネベートN軟膏・クリーム'] },
  ...
  { no: 70, name: 'ポリエンホスファチジルコリン', use: '高脂血症薬', group: 'other', ingredientKeys: ['ポリエンホスファチジルコリン'], rxExamples: ['EPLカプセル（現在は薬価収載なし）'] },
